  ...
  <div class="main-content">
    ...
    <div class="card" style="padding: 20px">
      <div style="margin-bottom: 10px; display: flex; align-items: center">
        <div style="flex: 1">
          <el-button @click="handleAdd" type="primary"><el-icon size="16" style="top: -1px"><CirclePlus /></el-icon> 我要反馈</el-button>
        </div>
        <div>
          <el-input v-model="data.title" prefix-icon="Search" style="width: 240px; margin-right: 10px" placeholder="请输入内容"></el-input>
      ...
      <div style="margin-bottom: 15px">
        <el-table stripe :data="data.tableData" @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="content" label="回复内容">
            <template #default="scope">
              <el-button type="primary" @click="view(scope.row.hfnr)">查看回复</el-button>
            </template>
          </el-table-column>
    ...
    <el-dialog title="信息反馈" v-model="data.formVisible" width="50%" :close-on-click-modal="false" destroy-on-close>
      <el-form ref="form" :model="data.form" label-width="70px" style="padding: 20px">
        ...
        <el-form-item label="附件图片" prop="img">
          <el-upload
