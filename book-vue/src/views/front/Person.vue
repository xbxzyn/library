<template>
  <div style="width: 40%; margin: 10px auto" class="card">
    <el-form ref="form" :model="data.user" :rules="rules" label-width="60px" style="padding: 20px">
      ...
      <el-form-item prop="bzr" label="班主任">
        <el-input disabled v-model="data.user.bzr" placeholder="请输入班主任"></el-input>
      </el-form-item>
      <el-form-item prop="nianji" label="年级">
        <el-input v-model="data.user.nianji" placeholder="请输入年级"></el-input>
      </el-form-item>
      <el-form-item prop="banji" label="班级">
        <el-input v-model="data.user.banji" placeholder="请输入班级"></el-input>
      </el-form-item>
