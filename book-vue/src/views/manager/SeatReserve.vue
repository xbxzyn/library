<template>
  <div>
    <div class="card" style="margin-bottom: 5px">
      <el-input v-model="data.roomName" prefix-icon="Search" style="width: 240px; margin-right: 10px" placeholder="请输入预览室名称查询"></el-input>
      <el-input v-model="data.seatNo" prefix-icon="Search" style="width: 240px; margin-right: 10px" placeholder="请输入座位编号查询"></el-input>
      <el-date-picker  v-model="data.yydate" type="date" placeholder="预约日期" 
